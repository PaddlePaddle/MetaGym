...
def test_continous_3d_maze(max_iteration):
    print("Testing Continuous 3D Maze...")
    maze_env = gym.make("meta-maze-continuous-3D-v0", enable_render=False)
    cell_scale = 9
...
def test_discrete_3d_maze(max_iteration):
    print("Testing Discrete 3D Maze...")
    maze_env = gym.make("meta-maze-discrete-3D-v0", enable_render=False)
    cell_scale = 9
    task = maze_env.sample_task(cell_scale=cell_scale, cell_size=2.0, wall_height=3.2)
    maze_env.set_task(task)
    iteration = 0
...
if __name__=="__main__":
    test_2d_maze(100)
    test_discrete_3d_maze(100)
    test_continuous_3d_maze(100)
