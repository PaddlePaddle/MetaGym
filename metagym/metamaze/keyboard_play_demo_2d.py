...
if __name__=='__main__':
    ...
    cell_scale = 9
    task = maze_env.sample_task(cell_scale=cell_scale, allow_loops=True, crowd_ratio=0.30)
    ...
    while True:
        ...
        if(not maze_env.key_done):
            ...
            task = maze_env.sample_task(cell_scale=cell_scale, allow_loops=True, crowd_ratio=0.32)
            maze_env.set_task(task)
        else:
            break
